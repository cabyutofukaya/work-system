...
use App\Models\Base\MeetingFile as BaseMeetingFile;
 ...
 * 日報コンテンツ
 */
class MeetingFile extends BaseMeetingFile implements Auditable
{
    use HasFactory;
    use SoftDeletes;
    use WhereLike;
    ...
    // {
    //     return $query->whereHas('meeting', function ($query) {
