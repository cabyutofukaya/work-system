 ...
 */
class ClientTravelController extends BaseController
{
    ...
    protected function detail($id): Show
    {
        ...
        // 固有情報
        $show->field("$this->client_type_table.payment_method", $this->trans('payment_method', $this->client_type_table));
        $show->field("$this->client_type_table.registration_number", $this->trans('registration_number', $this->client_type_table));
        $show->field("$this->client_type_table.group", $this->trans('group', $this->client_type_table));
    ...
    public function form(): Form
    {
        ...
        // 固有情報
        $form->radio("$this->client_type_table.payment_method", $this->trans('payment_method', $this->client_type_table))
            ->options(array_combine(array_values(config("const.client_types.travel.payment_methods")), config("const.client_types.travel.payment_methods")));
        $form->text("$this->client_type_table.registration_number", $this->trans('registration_number', $this->client_type_table));
        $form->radio("$this->client_type_table.group", $this->trans('group', $this->client_type_table))
            ->options(array_combine(array_values(config("const.client_types.travel.groups")), config("const.client_types.travel.groups")));
