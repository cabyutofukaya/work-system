 ...
 */
class ClientRestaurantController extends BaseController
{
    ...
    {
        // 会社タイプ
        $this->client_type_id = 'restaurant';
    ...
    protected function detail($id): Show
    {
        ...
        // 固有情報
        $show->field("$this->client_type_table.languages", $this->trans('languages', $this->client_type_table))
            ->unescape()
            ->as(function ($languages) {
                return collect($languages)->map(function ($language) {
                    return sprintf(
                        '%s',
    ...
    public function form(): Form
    {
        ...
        // 固有情報
        // rulesメソッドでは配列のバリデーションを設定できないため省略
        $form->checkbox("$this->client_type_table.languages", $this->trans('languages', $this->client_type_table))
            ->options(array_combine(array_values(config("const.client_types.restaurant.languages")), config("const.client_types.restaurant.languages")));
