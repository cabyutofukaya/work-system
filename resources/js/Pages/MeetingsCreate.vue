        ...
        <form @submit.prevent="create">
          <div class="description-form">
            ...
            <v-row>
              ...
              <v-col>
                <v-text-field prepend-icon="mdi-calendar" type="datetime-local" name="started_at"
                  v-model="form.started_at" :error="Boolean(form.errors.started_at)"
                  :error-messages="form.errors.started_at"></v-text-field>
              </v-col>
            </v-row>
            ...
            <v-row>
              ...
              <v-col>
                <v-textarea dense filled prepend-inner-icon="mdi-pencil" rows="3" name="participants"
                  v-model="form.participants" :error="Boolean(form.errors.participants)"
                  :error-messages="form.errors.participants"></v-textarea>
              </v-col>
            </v-row>
            ...
            <v-row>
              ...
              <v-col>
                <v-textarea dense filled prepend-inner-icon="mdi-pencil" name="content" v-model="form.content"
                  :error="Boolean(form.errors.content)" :error-messages="form.errors.content"></v-textarea>
              </v-col>
            </v-row>
          </div>
          ...
          <v-row>
            <v-col class="text-right">
              <v-btn color="primary" :small="$vuetify.breakpoint.xs" @click.native="create"
  ...
  methods: {
    ...
    create: function () {
      this.form.post(this.$route('meetings.store'), {
        ...
        onSuccess: () => this.$toasted.show('会議記録を作成しました'),
