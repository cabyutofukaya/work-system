    ...
    <Layout>
        ...
        <template>
            ...
            <v-col class="text-right">
                <a :href="$route('schedule.list.redirect', { department: loginUser.department })" target="_blank">
            ...
            <!-- <v-col class="text-right">
                <a :href="$route('schedule.redirect', { department: loginUser.department })" target="_blank">
                    <Button :small="$vuetify.breakpoint.xs">
                        メンバーのスケジュール表示
                    </Button>
                </a>
        ...
        <v-card flat tile>
            ...
            <FullCalendar class='demo-app-calendar' :options='calendarOptionsSmartphone' ref="fullCalendar"
                v-if="!$vuetify.breakpoint.smAndUp"></FullCalendar>

            <v-divider class="mx-4"></v-divider>

            <v-btn fab absolute bottom right color="primary" v-if="!$vuetify.breakpoint.smAndUp"
            ...
            <v-card flat tile>
                ...
                <form @submit.prevent="create">
                    ...
                    '06:00', '06:30', '07:00', '07:30', '08:00', '08:30', '09:00', '09:30', '10:00', '10:30', '11:00', '11:30', '12:00', '12:30', '13:00', '13:30', '14:00', '14:30', '15:00', '15:30', '16:00', '16:30', '17:00', '17:30', '18:00', '18:30', '19:00', '19:30', '20:00', '20:30', '21:00', '21:30', '22:00',
                                        ...
                                        :error="Boolean(form.errors.start_time)"
                                ...
                                <v-col>
                                    <v-select label="終了時間" :items="[
                    '06:00', '06:30', '07:00', '07:30', '08:00', '08:30', '09:00', '09:30', '10:00', '10:30', '11:00', '11:30', '12:00', '12:30', '13:00', '13:30', '14:00', '14:30', '15:00', '15:30', '16:00', '16:30', '17:00', '17:30', '18:00', '18:30', '19:00', '19:30', '20:00', '20:30', '21:00', '21:30', '22:00',
                ]" name="end_time" v-model="form.end_time" :disabled="form.enabled"
                                        :error="Boolean(form.errors.end_time)"
                            ...
                            <v-row>
                                <v-col v-if="!$vuetify.breakpoint.smAndUp">
                                    <v-text-field dense filled prepend-inner-icon="mdi-pencil" name="title"
                                        v-model="edit_form.title" maxlength="200"
                                        :error="Boolean(edit_form.errors.title)"
                        ...
                        <div class="description-form">
                            ...
                            <v-row>
                                ...
                                <v-col>
                                    ...
                                    <v-select label="開始時間" :items="[
                    '06:00', '06:30', '07:00', '07:30', '08:00', '08:30', '09:00', '09:30', '10:00', '10:30', '11:00', '11:30', '12:00', '12:30', '13:00', '13:30', '14:00', '14:30', '15:00', '15:30', '16:00', '16:30', '17:00', '17:30', '18:00', '18:30', '19:00', '19:30', '20:00', '20:30', '21:00', '21:30', '22:00',
                ]" name="start_time" v-model="edit_form.start_time" :disabled="edit_form.enabled"
...
export default {
    ...
    mounted() {
        ...
        // console.log(calendar_frame);
        calendar_frame.style.width = '100%';
