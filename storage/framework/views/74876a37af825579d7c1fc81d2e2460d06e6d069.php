<?php
    ...
    if ($errors->hasBag('exception')) {
        Log::error($error->first('message').$error->first('trace'));
    }
?>
...
<?php endif; ?>
<?php /**PATH /Applications/MAMP/htdocs/grouptube-biz/group_tube/resources/views/vendor/admin/partials/exception.blade.php ENDPATH**/ ?>