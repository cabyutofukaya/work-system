<script <?php if(isset($csp_script_nonce) && $csp_script_nonce): ?> nonce="<?php echo e($csp_script_nonce, false); ?>" <?php endif; ?>>
    Sfjs = (function() {
        "use strict";
        ...
        if (window.XMLHttpRequest && XMLHttpRequest.prototype.addEventListener) {
            ...
            XMLHttpRequest.prototype.open = function(method, url, async, user, pass) {
                ...
                var path = url;
                if (url.substr(0, 1) === '/') {
                    if (0 === url.indexOf('<?php echo e(asset('/'), false); ?>')) {
                        path = url.substr(<?php echo e(strlen( asset('/')), false); ?>);
                    }
                }
                else if (0 === url.indexOf('<?php echo e(url('/'), false); ?>')) {
                    path = url.substr(<?php echo e(strlen( url('/')), false); ?>);
                }
        ...
        return {
            ...
            loadToolbar: function(token, newToken) {
                ...
                this.load(
                    'sfwdt' + token,
                    '<?php echo e(route("telescope-toolbar.render", ["token" => "xxxxxx"]), false); ?>'.replace(/xxxxxx/, newToken),
                    function(xhr, el) {
                    ...
                    function(xhr) {
                        if (xhr.status !== 0) {
                            ...
                            var url = '<?php echo e(route("telescope"), false); ?>';
                            sfwdt.innerHTML = '\
...
<?php /**PATH /Applications/MAMP/htdocs/grouptube-biz/group_tube/vendor/fruitcake/laravel-telescope-toolbar/src/../resources/views/base_js.blade.php ENDPATH**/ ?>