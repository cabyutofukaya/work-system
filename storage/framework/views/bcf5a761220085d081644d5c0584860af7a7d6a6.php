...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('/vendor/telescope/favicon.ico'), false); ?>">

    <meta name="robots" content="noindex, nofollow">

    <title>Telescope<?php echo e(config('app.name') ? ' - ' . config('app.name') : '', false); ?></title>

    <!-- Style sheets-->
    <link href="https://fonts.bunny.net/css?family=Nunito" rel="stylesheet">
    <link href="<?php echo e(asset(mix($cssFile, 'vendor/telescope')), false); ?>" rel="stylesheet" type="text/css">
</head>
<body>
<div id="telescope" v-cloak>
    ...
    <div class="container mb-5">
        <div class="d-flex align-items-center py-4 header">
            ...
            <h4 class="mb-0 ml-3"><strong>Laravel</strong> Telescope<?php echo e(config('app.name') ? ' - ' . config('app.name') : '', false); ?></h4>
...
<script src="<?php echo e(asset(mix('app.js', 'vendor/telescope')), false); ?>"></script>
</body>
</html>
<?php /**PATH /home/shin-gt/grouptube-biz/production/releases/17/vendor/laravel/telescope/resources/views/layout.blade.php ENDPATH**/ ?>